    ...
    <div className="bg-radial-aurora">
      <section className="mx-auto grid max-w-7xl gap-8 px-6 py-14 lg:grid-cols-[1.25fr_0.75fr] lg:items-center lg:px-12 lg:py-20">
        ...
        <div className="relative lg:justify-self-end">
          ...
          <Card className="relative mx-auto w-full max-w-sm overflow-hidden border-white/10 bg-slate-950/70 p-0 shadow-2xl shadow-black/30 lg:mx-0">
            <div className="aspect-[4/5] max-h-[430px] overflow-hidden bg-slate-900">
