...
export function HomePage() {
  return (
    <div className="bg-radial-aurora">
      <section className="mx-auto grid max-w-7xl gap-10 px-6 py-20 lg:grid-cols-[1.2fr_0.8fr] lg:px-12 lg:py-28">
        ...
        <div className="relative">
          ...
          <Card className="relative mx-auto w-full max-w-md overflow-hidden border-white/10 bg-slate-950/70 p-0 shadow-2xl shadow-black/30">
            <div className="aspect-[3/4] max-h-[560px] overflow-hidden bg-slate-900">
              <img src={site.heroImage} alt={site.name} className="h-full w-full object-cover object-top" />
            </div>
